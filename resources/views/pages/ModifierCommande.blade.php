...
@section('content')
    ...
    <div class="ajouer_commande_page">
        ...
        {!! Form::open(['method'=>'PATCH','action' => ['GestionCommandeController@postModifier',$commande->id]]) !!}
        <div role="form" class="form-horizontal col-lg-offset-3 col-md-offset-3 col-sm-offset-3">
            <div class="form-group col-lg-10 col-md-10 col-xs-12 col-sm-10">
                <div class="col-md-5 col-xs-12 col-lg-5">
                    ...
                    {!! Form::text('numCommande', $commande->id, ['class' => 'form-control col-xs-12 col-lg-4 col-md-4', 'placeholder' => 'N° Commande', 'id'=>'Edit-numCommande', 'readonly']) !!}
                </div>
                <div>
                ...
                <div class="col-md-5 col-xs-12 col-lg-5">
                    ...
                    <input  class='form-control col-md-7 col-xs-12' type="date" name="dateAjout"  step="1" id="dateAjout" required="required" value="{{$commande->DateCreation}}" >
                </div>
                <div class="col-md-5 col-xs-12 col-lg-5">
                    <label for="status">Status</label>
                    <select name="statut" class="form-control col-xs-12 col-lg-4 col-md-4">
            ...
            <table id="example" class="table table-striped responsive-utilities jambo_table" >
                ...
                @foreach($lignes as $ligne)
                    <tr>
                        ...
                        <td id="montant-u-remise-ht">{{$ligne->MontantRemise}} </td>
        ...
        <div class="form-inline form-group col-lg-10 col-lg-offset-1">
            <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                ...
                <input type='numbre' step='0.1' class="form-control" id="total-remise" name="total-remise" value="{{DB::table('lignecommande')->where('idCommande','=',$commande->id)->sum('MontantRemise')}}" readonly>
            </div>
            <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <label for="total-ht" class="control-label col-lg-7 col-md-7 col-sm-7 col-xs-12">Total HT</label>
                <input type="text" class="form-control" id="total-ht" name="tatal-ht" value="{{$ht}}" readonly>
            </div>
            <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group ">
            <div class="col-md-10 col-xs-12 col-lg-10 col-lg-offset-8">
                <a href="{{ url('/commande/annuler/'.$commande->id ) }}" class="btn btn-danger btn-lg col-xs-12 col-md-4 col-lg-2 btn-ajouter-produit"> Annuler</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body"  id="formulaire">
                        <form method='POST' action='/commande/modifier/{{$commande->id}}'>
    ...
    <script>
        ...
        $(".delete").click(function () {
            ...
            document.getElementById("modal-footer-delete").innerHTML =
                    '<form method="POST" action="/commande/modifier/supprimer/'+id+'">'+
                    '<input name="_token" type="hidden" value="{{ csrf_token() }}"'+
                    '<div>'+
        ...
        function test($val)
        {
            ...
            $.get("/produitInfo?ID="+$val, function(res,stat){
                ...
                {
                    alert("La référence de prioduit n'exite pas");
                }
            });
        }
