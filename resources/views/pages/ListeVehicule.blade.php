    ...
    <div class="liste_client_page">
        ...
        <div role="form" class="form-horizontal col-lg-offset-2">
            ...
            <div class="form-group">
                ...
                <div class="">
                    <a href="{{ url('/vehicule/ajouter') }}" class="btn btn-success col-md-1 col-lg-1 col-xs-12" id="openBtn">Ajouter</a>
                </div>
                <div class="">
                ...
                @foreach($vehicules as $vehicule)
                    <tr class="even pointer" data-toggle="modal" data-id="{!! $i !!}" data-target="#orderModal">
                        ...
                        <td id="" style="text-align: center">
                            <a href="{{ url('vehicule/modifier/'.$vehicule->id ) }}" class="use-address modifier" id="openBtn" >
