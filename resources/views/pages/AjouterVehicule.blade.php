...
@section('content')
    <h1 class="header-page">Ajout d'un Véhicule</h1>
    <div class="x_content">
        <br>
        {!! Form::open(['method'=>'POST','action' => ['VehiculeController@insererVehicule'], 'class'=>'form-horizontal form-label-left']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('matricule',null,['class'=>'form-control col-md-7 col-xs-12', 'id'=>'matricule', 'data-parsley-id'=>'9303', 'required'=>'required' ,'onkeypress'=> 'validate(event)', 'maxlength'=>'11']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('KMDebut',null,['class'=>'form-control col-md-7 col-xs-12', 'id'=>'KMDebut', 'data-parsley-id'=>'8525', 'required'=>'required','onkeypress'=> 'validate(event)']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('capacite',null,['class'=>'form-control col-md-7 col-xs-12', 'id'=>'capacite', 'data-parsley-id'=>'9303', 'required'=>'required','onkeypress'=> 'validate(event)']) !!}
    ...
    <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-7 col-sm-offset-7 col-xs-offset-7 ">
            <a class="btn btn-primary" href="{{ url('/vehicule') }}">Annuler</a>
