    ...
    <div class="ajouer_commande_page">
            ...
            <table id="example" class="table table-striped responsive-utilities jambo_table" >
                ...
                @foreach($lignes as $ligne)
                    <tr>
                        ...
                        <td id="montant-u-remise-ht">{{$ligne->PrixHT*$ligne->tauxRemise*(-0.01)}}</td>
        ...
        <div class="form-group ">
            <div class="col-md-10 col-xs-12 col-lg-10 col-lg-offset-10">
                <a href="{{ url('/commande') }}" class="btn btn-success btn-lg col-xs-12 col-md-4 col-lg-2 btn-ajouter-produit"> Fermer</a>
            </div>
        </div>
