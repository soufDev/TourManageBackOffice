...
@section('content')
    <div ng-app="myApp">
        <div ng-controller="planifierTourneeController">
            <h1 class="header-page">Suivi Tournée</h1>
            {!! Form::open(['url'=>'#']) !!}
            ...
            <div class="form-group">
                            ...
                            <div class="panel-body table-responsive">
                                <table datatable="ng" class="row-border hover table table-striped responsive-utilities jambo_table">
                                    ...
                                    <tr ng-repeat="etape in etapes">
                                        ...
                                        <td id="modifier">@{{ etape.statut }}</td>
                            ...
                            <div class="panel-body table-responsive">
                                <table datatable="ng" class="row-border hover table table-striped responsive-utilities jambo_table">
                                    ...
                                    <tr ng-repeat="livraison in livraisons">
                                        ...
                                        <td id="nom-client">@{{ livraison.motifnonlivraison }}</td>
                                        <td id="details">
                            ...
                            <div class="panel-body table-responsive">
                                <table datatable="ng" class="row-border hover table table-striped responsive-utilities jambo_table">
                                    ...
                                    <tr>
                                        ...
                                        <th>Quantité Initiale Transporteur</th >
                                        <th>Quantité Finale Transporteur</th >
                                        <th>Ecart Stock</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr ng-repeat="stock in stockTournees">
                                        ...
                                        <td id="quantite">@{{ stock.stockinitialestime }}</td>
                                        <td id="quantite">@{{ stock.stockinitialReel }}</td>
                                        <td id="quantite">@{{ stock.stockEncours }}</td>
                                        <td id="ecrat-stock">@{{ stock.stockinitialReel - stock.stockEncours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="form-horizontal col-lg-9 col-md-12 col-sm-12 col-xs-12 col-md-offset-0 col-lg-offset-4">
                    <div class="form-group col-lg-3 col-md-6 col-xs-12 col-sm-6">
                        <label for="motif-ecart"> Motif de l'Ecart du Stock</label>
                        {!! Form::select('motif-ecart',['motiv1'=>'motif1','motif2'=>'motif2','motif3'=>'motif3'],null,['class'=>'form-control', 'id'=>'motif-ecart']) !!}
                    </div>

                    <div class="form-group col-lg-3 col-md-6 col-xs-12 col-sm-6">
                        <label for="transporteur">Autre</label>
                        {!! Form::text('autre-motif',null,['class'=>'form-control','id'=>'transporteur']) !!}
                    </div>
                    <div class="form-group col-lg-8 pull-right">
                        <button type="button" class="btn btn-lg btn-dark col-lg-2 col-xs-12 col-lg-offset-8">Retour</button>
                    </div>
                    {!! Form::close() !!}
